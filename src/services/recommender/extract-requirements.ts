...
- priorities: up to 7 entries, one per aspect you can infer (camera, battery, performance, display, build, software, value). Weights should reflect emphasis; they will be renormalised to sum to 1.
...
- form_factor.foldable true only if they want a foldable. weight_max_g / screen_size_range_in only if stated.
